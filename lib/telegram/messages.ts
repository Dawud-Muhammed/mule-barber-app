...
const messages: Record<Language, Record<MessageKey, MessageTemplate>> = {
  am: {
    ...
    btn_join: 'ቀላቀል',
    btn_cancel: 'ሰርዝ',
    joined: (params) => `ቁጥር ${params.n} ነዎት። ከእርስዎ በፊት ${params.a} ሰዎች አሉ። ተራዎ ሲቃረብ መልእክት እንልክልዎታለን።`,
    joined_next: 'ቀጣይ ነዎት። እባክዎ አቅራቢያ ይሁኑ።',
    position_check: (params) => `ቁጥር ${params.n} ነዎት። ከእርስዎ በፊት ${params.a} ሰዎች አሉ።`,
    not_in_line: 'ዛሬ በወረፋ ላይ የሉም። መቀላቀል ይፈልጋሉ?',
    already_in_line: (params) => `አስቀድመው በወረፋ ላይ ነዎት — ቁጥር ${params.n}። ከእርስዎ በፊት ${params.a} ሰዎች አሉ።`,
  ...
  en: {
    ...
    btn_join: 'Join',
    btn_cancel: 'Cancel',
    joined: (params) => `You are number ${params.n} in line. ${params.a} people are ahead of you. We will message you when your turn is near.`,
    joined_next: 'You are next in line. Please stay close.',
    position_check: (params) => `You are number ${params.n} in line. ${params.a} people are ahead of you.`,
    not_in_line: 'You are not in line today. Want to join?',
    already_in_line: (params) => `You are already in line - number ${params.n}. ${params.a} people are ahead of you.`,
